...
m_strStatus = g_MSG_NEED_LOGIN
m_strError = g_MSG_BAD_LOGIN
...
<tr bgcolor="#<%=g_arColor(4)%>" valign="bottom">
	...
	<b><%=g_TITLE_LOGIN%></b></font></td>
<tr>
	<td colspan=4 align="center"><font face="<%=g_arFont(2)%>" size=2>
	<%=m_strStatus%><br></font></td>
<tr>
	<td>&nbsp;</td>
	<td bgcolor="#<%=g_arColor(12)%>" align="right"><font face="<%=g_arFont(2)%>"><%=g_FRM_USERNAME%>:&nbsp;</td>
	<td bgcolor="#<%=g_arColor(12)%>"><input type="text" name="fldUserName" size=10 value="<%=Request.Form("login")%>"></td>
	<td>&nbsp;</td>
<tr>
	<td>&nbsp;</td>
	<td bgcolor="#<%=g_arColor(12)%>" align="right"><font face="<%=g_arFont(2)%>"><%=g_FRM_PASSWORD%>:&nbsp;</td>
	<td bgcolor="#<%=g_arColor(12)%>"><input type="password" name="fldPassword" size=10></td>
	<td>&nbsp;</td>
<tr>
	<td colspan=4 align="center"><%=makeButton(g_BTN_CONTINUE,"javascript:document.frmLogin.submit();","submit",15,80)%></td>
</table>
